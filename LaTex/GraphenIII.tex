...
\begin{frame}{Perfektes Matching}
...
\begin{frame}{Maximales Matching}
\begin{center}
\begin{tikzpicture}[auto, thick]
\node[state] (1) at (3, 7) {};
\node[state] (2) at (1, 5) {};
...
(3) edge[-] node {} (6)
(4) edge[-] node {} (7)
(5) edge[-, thick, color=red] node {} (6)
(6) edge[-] node {} (7)
(1) edge[-, thick, color=red] node {} (7);

\end{tikzpicture}
\end{center}
\end{frame}

\begin{frame}{Kardinalit\"atsmaximales Matching}
\begin{center}
\begin{tikzpicture}[auto, thick]
\node[state] (1) at (3, 7) {};
\node[state] (2) at (1, 5) {};
...
(1) edge[-] node {} (3)
(1) edge[-] node {} (4)
(2) edge[-, thick, color=red] node {} (5)
(2) edge[-] node {} (6)
(3) edge[-] node {} (5)
(3) edge[-, thick, color=red] node {} (6)
(4) edge[-, thick, color=red] node {} (7)
(5) edge[-] node {} (6)
(6) edge[-] node {} (7)
(1) edge[-] node {} (7);
...
\path
(2) edge[-] node {} (5)
(2) edge[-, thick, color=red] node {} (6)
(3) edge[-, thick, color=red] node {} (5)
(3) edge[-] node {} (6)
(4) edge[-, thick, color=red] node {} (7)
(5) edge[-] node {} (6)
(6) edge[-] node {} (7);
...
(2) edge[->] node {} (6)
(3) edge[->, color=red] node {} (6)
(3) edge[->] node {} (8)
(4) edge[->] node {} (6)
(4) edge[->, color=red] node {} (7)
(4) edge[->] node {} (8)
(5) edge[->] node {} (6)
(5) edge[->] node {} (7)
(5) edge[->, color=red] node {} (8)
...
\path
(1) edge[-] node {} (3)
(1) edge[-, color=red] node {$m_{1}$} (4)
(2) edge[-, color=red] node {$m_{2}$} (5)
(2) edge[-] node {} (4)
(1) edge[-] node {} (5);
